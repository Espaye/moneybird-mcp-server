...
>
> **Bèta 0.8.2.** De ondersteunde opstelling is een lokale MCP-server via stdio. De server start technisch afgedwongen in alleen-lezenmodus. Experimentele schrijfacties vereisen een expliciete lokale inschakeling en gecontroleerde goedkeuring.
