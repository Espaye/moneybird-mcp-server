...
class ToolSearchRankingTests(unittest.TestCase):
    ...
    QUERIES = {
        ...
        "winst en verlies rekening": "get_financial_report",
        "balans opvragen": "get_financial_report",
        "welke factuur hoort bij deze bankmutatie": "suggest_bank_mutation_matches",
        "boekhoud playbook btw regels": "get_bookkeeping_guide",
        "bonnen van dit jaar": "list_purchase_documents",
